...
import { Calendar, CheckCircle, Settings, Trash2, RefreshCw, ExternalLink, Mail } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 p-6">
      <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-12">
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
              {integrations.map((integration) => {
                ...
                return (
                  <Card key={integration.id} className="glass-card border-white/20 bg-black/20">
          ...
          <div>
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
              {INTEGRATION_PROVIDERS.filter(p => p.type === 'task_manager').map((provider) => {
                ...
                return (
                  <Card key={provider.id} className="glass-card border-white/20">
                    <CardHeader className="pb-4">
                      <div className="flex items-center space-x-3">
                        <div className={`p-2 rounded-lg ${provider.color}`}>
                          <IconComponent className="h-6 w-6 text-white" />
        ...
        <div className="mt-12 text-center">
          <Card className="glass-card border-white/20 max-w-2xl mx-auto bg-black/30">
            <CardContent className="p-6">
              <h4 className="text-lg font-semibold text-white mb-3 !text-white font-bold" style={{color: 'white !important'}}>
                How Integrations Work
              </h4>
              <div className="text-white space-y-2 text-left">
                <p className="text-white !text-white font-medium" style={{color: 'white !important'}}>• <strong className="text-white">Calendar Apps:</strong> Automatically create events for goal deadlines and important milestones</p>
                <p className="text-white !text-white font-medium" style={{color: 'white !important'}}>• <strong className="text-white">Task Managers:</strong> Sync your goal tasks with your preferred productivity tools</p>
                <p className="text-white !text-white font-medium" style={{color: 'white !important'}}>• <strong className="text-white">Real-time Sync:</strong> Changes in Goal Flow Pro are reflected in connected apps</p>
                <p className="text-white !text-white font-medium" style={{color: 'white !important'}}>• <strong className="text-white">Secure:</strong> We use OAuth 2.0 for secure, encrypted connections</p>
              </div>
            </CardContent>
          </Card>
        </div>
